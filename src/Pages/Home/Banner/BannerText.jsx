        ...
        <div className='container mx-auto'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 min-h-[550px] relative'>
                <div className='flex flex-col justify-center py-14 md:py-0 space-y-6 pl-0 md:pl-10'>
                    <h1 className='text-5xl lg:text-6xl xl:w-7xl text-white text-center md:text-start uppercase'>Gym Gives you the perfect <span className='text-primary'>Health</span></h1>
