    ...
    <section>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 min-h-[550px] relative'>
        <div className='flex flex-col justify-center py-14 md:py-0 space-y-6 pl-0 md:pl-10'>
          ...
          <p className='text-center md:text-start text-base-content/70 text-xl'>Stay strong, stay fit – the gym helps you build a healthy body and a balanced lifestyle.</p>
