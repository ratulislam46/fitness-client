    ...
    return (
        <div className="max-w-5xl mx-auto mt-16 px-4 py-12">
            ...
            <div className="bg-base-100 shadow rounded-xl border border-base-content/5 p-6 mb-8">
                <p className="text-2xl">Trainer: {slot.trainerName}</p>
                <p className="text-2xl">Selected Slot: {slot.slotName}</p>
                <p className="text-2xl">Classes: {slot.selectedClasses?.join(", ")}</p>
            </div>

            {/* Plan Selection Form */}
            <form onChange={handlePlanSelect}>
                <h3 className="text-xl font-semibold mb-4 text-base-content">Choose a Membership Plan:</h3>
